...
export function TeaserFlexGridBlock({value, onChange}: BlockProps<TeaserFlexGridBlockValue>) {
  ...
  function handleTeaserContentChange(i: number, teaserLink: Teaser | null) {
    onChange({
      ...value,
      gridItems: Object.assign([], gridItems, {
        [i]: teaserLink || null
      })
    })
  }
  ...
  return (
    <>
      ...
      {/* <p>{JSON.stringify(gridItems.layout)}</p> */}
      <GridLayout
        className="layout"
        cols={numColumns}
        rowHeight={numRows}
        ...
        {gridItems.map(({teaser}, i) => (
          <div key={String(i)}>
            ...
            <TeaserBlock
              ...
              onRemove={() => {
                handleTeaserContentChange(i, null)
              }}
            />
          </div>
        ))}
      ...
      <Drawer show={isEditModalOpen} size={'sm'} onHide={() => setEditModalOpen(false)}>
        <TeaserEditPanel
          ...
          onConfirm={teaser => {
            ...
            handleTeaserContentChange(editIndex, teaser)
          }}
        />
      </Drawer>
